...
type LoginOpenAICodexOAuth =
  (typeof import("civitas/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("civitas/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("civitas/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("civitas/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("civitas/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/provider-auth-login")>(
    "civitas/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/provider-auth")>(
    "civitas/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
