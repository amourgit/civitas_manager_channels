...
export function resolveSearxngCategories(config?: CIVITASConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: CIVITASConfig): string | undefined {
