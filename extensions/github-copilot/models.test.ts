...
vi.mock("civitas/plugin-sdk/provider-model-shared", () => ({
...
vi.mock("civitas/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("civitas/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/civitas-state",
}));

import type { ProviderResolveDynamicModelContext } from "civitas/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/civitas-state/credentials/github-copilot.token.json";
