...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CIVITASConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CIVITASConfig["channels"]>["slack"]>>,
): CIVITASConfig {
  return {
    channels: {
      slack: {
