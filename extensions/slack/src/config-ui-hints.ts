import type { ChannelConfigUiHint } from "civitas/plugin-sdk/channel-core";
...
export const slackChannelConfigUiHints = {
  ...
  execApprovals: {
    ...
    help: "Slack-native exec approval routing and approver authorization. When unset, CIVITAS auto-enables DM-first native approvals if approvers can be resolved for this workspace account.",
  },
  ...
  "execApprovals.approvers": {
    ...
    help: "Slack user IDs allowed to approve exec requests for this workspace account. Use Slack user IDs or user targets such as `U123`, `user:U123`, or `<@U123>`. If you leave this unset, CIVITAS falls back to commands.ownerAllowFrom when possible.",
  },
