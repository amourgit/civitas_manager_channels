import { formatInboundEnvelope } from "civitas/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "civitas/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("civitas/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
