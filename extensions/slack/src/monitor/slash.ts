...
import { type ChatCommandDefinition, type CommandArgs } from "civitas/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "civitas/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "civitas_cmdarg";
