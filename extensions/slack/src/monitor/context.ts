...
import type { DmPolicy, GroupPolicy } from "civitas/plugin-sdk/config-runtime";
import { createDedupeCache } from "civitas/plugin-sdk/core";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("civitas/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
