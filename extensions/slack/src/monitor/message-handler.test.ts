...
vi.mock("civitas/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/channel-inbound")>(
    "civitas/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
