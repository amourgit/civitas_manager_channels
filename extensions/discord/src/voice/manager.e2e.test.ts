...
vi.mock("civitas/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/routing")>(
    "civitas/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/agent-runtime")>(
    "civitas/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/media-understanding-runtime", () => ({
