...
import { createScopedChannelConfigAdapter } from "civitas/plugin-sdk/channel-config-helpers";
import type { ChannelDoctorAdapter } from "civitas/plugin-sdk/channel-contract";
