...
vi.mock("civitas/plugin-sdk/acp-runtime", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/acp-runtime")>(
    "civitas/plugin-sdk/acp-runtime",
  );
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/command-auth", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/command-auth")>(
    "civitas/plugin-sdk/command-auth",
  );
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/runtime-env", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/runtime-env")>(
    "civitas/plugin-sdk/runtime-env",
  );
  return {
    ...actual,
