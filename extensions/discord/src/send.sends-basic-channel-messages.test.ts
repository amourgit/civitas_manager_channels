...
vi.mock("civitas/plugin-sdk/web-media", () => discordWebMediaMockFactory());
...
let loadWebMedia: typeof import("civitas/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("civitas/plugin-sdk/web-media"));
