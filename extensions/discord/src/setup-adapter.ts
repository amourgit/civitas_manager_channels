import { createEnvPatchedAccountSetupAdapter } from "civitas/plugin-sdk/setup-adapter-runtime";
import type { ChannelSetupAdapter } from "civitas/plugin-sdk/setup-runtime";
