import { resolveGlobalMap } from "civitas/plugin-sdk/global-singleton";
import type { DiscordComponentEntry, DiscordModalEntry } from "./components.js";

const DEFAULT_COMPONENT_TTL_MS = 30 * 60 * 1000;
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("civitas.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("civitas.discord.modalEntries");
