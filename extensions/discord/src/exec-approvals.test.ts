...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CIVITASConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CIVITASConfig["channels"]>["discord"]>>,
): CIVITASConfig {
  return {
    channels: {
      discord: {
