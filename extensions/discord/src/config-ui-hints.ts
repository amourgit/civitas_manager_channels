...
export const discordChannelConfigUiHints = {
  ...
  "eventQueue.listenerTimeout": {
    ...
    help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in CIVITAS; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
  },
