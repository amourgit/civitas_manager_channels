import type { DirectoryConfigParams } from "civitas/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "civitas/plugin-sdk/messaging-targets";
