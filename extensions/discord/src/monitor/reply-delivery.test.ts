...
vi.mock("civitas/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/retry-runtime")>(
    "civitas/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
