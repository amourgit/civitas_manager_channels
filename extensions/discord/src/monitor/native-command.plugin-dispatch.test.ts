...
vi.mock("civitas/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/plugin-runtime")>(
    "civitas/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("civitas/plugin-sdk/plugin-runtime")
    >("civitas/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("civitas/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("civitas/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("civitas/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
