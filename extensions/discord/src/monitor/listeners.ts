...
type LoadedConfig = ReturnType<typeof import("civitas/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("civitas/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("civitas/plugin-sdk/runtime-env").createSubsystemLogger>;
