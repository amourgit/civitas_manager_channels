...
import { resolveOpenProviderRuntimeGroupPolicy } from "civitas/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "civitas/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("civitas/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("civitas/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function loadReplyRuntime() {
  replyRuntimePromise ??= import("civitas/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("civitas/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__civitas_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__civitas_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__civitas_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__civitas_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__civitas_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__civitas_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
