...
import type { resolveAgentRoute } from "civitas/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("civitas/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("civitas/plugin-sdk/runtime-env").RuntimeEnv;
