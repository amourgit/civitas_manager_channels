...
let listNativeCommandSpecs: typeof import("civitas/plugin-sdk/command-auth").listNativeCommandSpecs;
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("civitas/plugin-sdk/command-auth"));
