...
import { shouldHandleTextCommands } from "civitas/plugin-sdk/command-surface";
...
import type { SessionBindingRecord } from "civitas/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "civitas/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "civitas/plugin-sdk/reply-history";
import { DEFAULT_ACCOUNT_ID } from "civitas/plugin-sdk/routing";
import { logVerbose, shouldLogVerbose } from "civitas/plugin-sdk/runtime-env";
import { getChildLogger } from "civitas/plugin-sdk/runtime-env";
import { logDebug } from "civitas/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("civitas/plugin-sdk/conversation-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("civitas/plugin-sdk/conversation-runtime");
