...
let runtimeEnvModule: typeof import("civitas/plugin-sdk/runtime-env");
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("civitas/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("civitas/plugin-sdk/runtime-env");
