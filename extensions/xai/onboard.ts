...
>({
  ...
  resolveParams: (_cfg: CIVITASConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: CIVITASConfig): CIVITASConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: CIVITASConfig): CIVITASConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: CIVITASConfig): CIVITASConfig {
