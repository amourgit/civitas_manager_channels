                ...
                content: [
                  {
                    type: "output_text",
                    text: "Found X posts",
                    annotations: [{ type: "url_citation", url: "https://x.com/civitas/status/1" }],
                  },
                ],
              },
            ],
            citations: ["https://x.com/civitas/status/1"],
          },
        ),
    } as Response),
  );
