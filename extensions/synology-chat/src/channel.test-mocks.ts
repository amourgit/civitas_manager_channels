...
vi.mock("civitas/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("civitas/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("civitas/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("civitas/plugin-sdk/webhook-ingress");
  return {
    ...actual,
