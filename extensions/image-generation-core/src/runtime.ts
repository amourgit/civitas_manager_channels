...
function buildNoImageGenerationModelConfiguredMessage(cfg: CIVITASConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: CIVITASConfig }) {
