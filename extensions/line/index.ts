import { defineChannelPluginEntry, type CIVITASPluginApi } from "civitas/plugin-sdk/core";
...
type RegisteredLineCardCommand = Parameters<CIVITASPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: CIVITASPluginApi): Promise<RegisteredLineCardCommand> {
