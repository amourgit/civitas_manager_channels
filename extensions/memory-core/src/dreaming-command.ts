...
function resolveMemoryCorePluginConfig(cfg: CIVITASConfig): Record<string, unknown> {
...
function updateDreamingModeInConfig(cfg: CIVITASConfig, mode: DreamingMode): CIVITASConfig {
...
function formatStatus(cfg: CIVITASConfig): string {
...
export function registerDreamingCommand(api: CIVITASPluginApi): void {
  api.registerCommand({
    name: "dreaming",
