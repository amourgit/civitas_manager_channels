...
const MCPORTER_STATE_KEY = Symbol.for("civitas.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("civitas.qmdEmbedQueueTail");
...
vi.mock("civitas/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("civitas/plugin-sdk/memory-core-host-engine-foundation")
  >("civitas/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("civitas/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/file-lock")>(
    "civitas/plugin-sdk/file-lock",
  );
  return {
    ...actual,
...
} from "civitas/plugin-sdk/memory-core-host-engine-storage";
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: CIVITASConfig }) {
