...
} from "civitas/plugin-sdk/memory-core-host-engine-embeddings";
import { resolveUserPath } from "civitas/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "civitas/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall OpenClaw (this should install node-llama-cpp): npm i -g civitas@latest"
      : null,
