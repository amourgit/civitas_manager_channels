import { ensureModelAllowlistEntry } from "civitas/plugin-sdk/provider-onboard";
import {
...
export function applyOpenAIProviderConfig(cfg: CIVITASConfig): CIVITASConfig {
...
export function applyOpenAIConfig(cfg: CIVITASConfig): CIVITASConfig {
