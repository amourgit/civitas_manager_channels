import type { ProviderRuntimeModel } from "civitas/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-civitas-session-id": "session-123",
        "x-civitas-turn-id": "turn-123",
        "x-civitas-turn-attempt": "2",
      },
      metadata: {
        civitas_session_id: "session-123",
        civitas_turn_id: "turn-123",
        civitas_turn_attempt: "2",
        civitas_transport: "websocket",
      },
    });
  });
