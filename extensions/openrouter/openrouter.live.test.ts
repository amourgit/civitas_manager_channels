...
const LIVE_MODEL_ID =
  process.env.CIVITAS_LIVE_OPENROUTER_PLUGIN_MODEL?.trim() || "openai/gpt-5.4-nano";
const liveEnabled = OPENROUTER_API_KEY.trim().length > 0 && process.env.CIVITAS_LIVE_TEST === "1";
