...
This package contains the **BlueBubbles external channel plugin** for CIVITAS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `CIVITAS/plugin-sdk` helpers.
