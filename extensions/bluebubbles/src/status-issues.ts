import { collectIssuesForEnabledAccounts } from "civitas/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: civitas channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
