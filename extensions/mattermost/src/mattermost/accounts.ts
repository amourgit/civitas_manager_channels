import { createAccountListHelpers } from "civitas/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "civitas/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "civitas/plugin-sdk/account-resolution";
...
export function listMattermostAccountIds(cfg: CIVITASConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: CIVITASConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CIVITASConfig): ResolvedMattermostAccount[] {
