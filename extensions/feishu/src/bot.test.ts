import type * as ConversationRuntime from "civitas/plugin-sdk/conversation-runtime";
...
async function dispatchMessage(params: { cfg: ChanneldbotConfig; event: FeishuMessageEvent }) {
