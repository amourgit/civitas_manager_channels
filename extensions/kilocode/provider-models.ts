import type { KilocodeModelCatalogEntry } from "civitas/plugin-sdk/provider-model-shared";
import type { ModelDefinitionConfig } from "civitas/plugin-sdk/provider-model-shared";
