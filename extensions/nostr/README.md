...
Nostr DM channel plugin for CIVITAS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to CIVITAS. It enables your bot to:
...
```bash
CIVITAS plugins install @CIVITAS/nostr
```
...
# Configure CIVITAS to use local relay
