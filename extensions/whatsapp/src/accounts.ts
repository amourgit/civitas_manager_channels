...
export function listWhatsAppAuthDirs(cfg: CIVITASConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CIVITASConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CIVITASConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CIVITASConfig): ResolvedWhatsAppAccount[] {
