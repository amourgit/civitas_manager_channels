...
function areWhatsAppAgentReactionsEnabled(params: { cfg: CIVITASConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: CIVITASConfig) {
