...
vi.mock("civitas/plugin-sdk/provider-web-search", () => ({
...
vi.mock("civitas/plugin-sdk/security-runtime", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: civitas", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "civitas" });
  });

  it("runTavilyExtract sends X-Client-Source: civitas", async () => {
