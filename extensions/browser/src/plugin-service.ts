...
export function createBrowserPluginService(): CIVITASPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "CIVITAS_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "CIVITAS_BROWSER_CONTROL_MODULE",
