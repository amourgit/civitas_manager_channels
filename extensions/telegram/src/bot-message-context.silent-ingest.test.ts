...
vi.mock("civitas/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("civitas/plugin-sdk/hook-runtime")>(
    "civitas/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
