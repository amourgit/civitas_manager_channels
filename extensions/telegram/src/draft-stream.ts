...
import { createFinalizableDraftLifecycle } from "civitas/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("civitas.telegramDraftStreamState");
