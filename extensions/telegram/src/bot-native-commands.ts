...
import { getRuntimeConfigSnapshot } from "civitas/plugin-sdk/runtime-config-snapshot";
...
type TelegramChunkMode = ReturnType<
  typeof import("civitas/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("civitas/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
