...
import {
  ...
  type CIVITASConfig,
} from "civitas/plugin-sdk/account-core";
import type {
...
import { formatSetExplicitDefaultInstruction } from "civitas/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "civitas/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.CIVITAS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: CIVITASConfig): string[] {
...
export function listTelegramAccountIds(cfg: CIVITASConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: CIVITASConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/civitas/civitas/issues/30673
...
export function listEnabledTelegramAccounts(cfg: CIVITASConfig): ResolvedTelegramAccount[] {
