...
type ResolveConfiguredBindingRouteFn =
  typeof import("civitas/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("civitas/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/civitas-sessions.json");
