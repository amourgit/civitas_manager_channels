...
import { resolveApiKeyForProvider } from "civitas/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "civitas/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { describeImageFileWithModel } from "civitas/plugin-sdk/media-understanding-runtime";
