...
vi.mock("civitas/plugin-sdk/config-runtime", async () => {
  const original = (await vi.importActual("civitas/plugin-sdk/config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("civitas/plugin-sdk/text-runtime", async () => {
  const original = (await vi.importActual("civitas/plugin-sdk/text-runtime")) as Record<
    string,
    unknown
  >;
  return {
