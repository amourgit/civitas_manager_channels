...
import { resolveHumanDelayConfig } from "civitas/plugin-sdk/agent-runtime";
import {
...
import { recordInboundSession } from "civitas/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "civitas/plugin-sdk/host-runtime";
import { waitForTransportReady } from "civitas/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "civitas/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "civitas/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "civitas/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "civitas/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "civitas/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "civitas/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "civitas/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "civitas/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T civitas@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., civitas@192.168.64.3)
