...
function mergeIMessageAccountConfig(cfg: CIVITASConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CIVITASConfig): ResolvedIMessageAccount[] {
