import { describeWebhookAccountSnapshot } from "civitas/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "civitas/plugin-sdk/allow-from";
import {
  adaptScopedAccountAccessor,
  createScopedChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "civitas/plugin-sdk/channel-config-helpers";
import { createAccountStatusSink } from "civitas/plugin-sdk/channel-lifecycle";
import {
  createLoggedPairingApprovalNotifier,
  createPairingPrefixStripper,
} from "civitas/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "civitas/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "civitas/plugin-sdk/core";
import { runStoppablePassiveMonitor } from "civitas/plugin-sdk/extension-shared";
import {
