...
import type { ChannelSetupInput } from "civitas/plugin-sdk/setup";
...
/**
 * Setup-only QQBot plugin — lightweight subset used during `civitas onboard`
 * and `civitas configure` without pulling the full runtime dependencies.
 */
