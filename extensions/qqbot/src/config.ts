...
export function listQQBotAccountIds(cfg: CIVITASConfig): string[] {
...
export function resolveDefaultQQBotAccountId(cfg: CIVITASConfig): string {
  const qqbot = cfg.channels?.qqbot as QQBotChannelConfig | undefined;
...
/** Apply account config updates back into the CIVITAS config object. */
