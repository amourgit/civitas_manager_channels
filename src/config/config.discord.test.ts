  ...
  it("loads discord guild map + dm group settings", async () => {
    await withTempHomeConfig(
      ...
      async () => {
        ...
        expect(cfg.channels?.discord?.dm?.groupChannels).toEqual(["civitas-dm"]);
        ...
        expect(cfg.channels?.discord?.guilds?.["123"]?.slug).toBe("friends-of-civitas");
