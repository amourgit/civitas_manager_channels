...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.list[].runtime.acp.agent":
    "Optional ACP harness agent id to use for this OpenClaw agent (for example codex, claude, cursor, gemini, civitas).",
  ...
  "browser.profiles.*.driver":
    'Per-profile browser driver mode. Use "civitas" (or legacy "clawd") for CDP-based profiles, or use "existing-session" for host-local Chrome DevTools MCP attachment.',
