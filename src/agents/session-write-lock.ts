...
const CLEANUP_STATE_KEY = Symbol.for("civitas.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("civitas.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("civitas.sessionWriteLockWatchdogState");
