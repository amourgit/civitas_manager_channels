...
function resolveAdaptiveReadMaxBytes(options?: CIVITASReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createCIVITASReadTool(base, {
...
export function createCIVITASReadTool(
  base: AnyAgentTool,
  options?: CIVITASReadToolOptions,
): AnyAgentTool {
