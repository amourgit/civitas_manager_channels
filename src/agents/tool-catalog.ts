...
function buildCoreToolGroupMap() {
  ...
  const civitasTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInCIVITASGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:civitas": civitasTools,
