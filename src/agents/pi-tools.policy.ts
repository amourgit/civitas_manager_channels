...
export function resolveSubagentToolPolicy(cfg?: CIVITASConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: CIVITASConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: CIVITASConfig["tools"];
