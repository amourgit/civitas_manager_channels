...
async function resolveContext(config: CIVITASConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CIVITASConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
