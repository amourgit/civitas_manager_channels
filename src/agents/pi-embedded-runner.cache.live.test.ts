...
describeCacheLive("pi embedded runner prompt caching (live)", () => {
  beforeAll(async () => {
    liveRunnerRootDir = await fs.mkdtemp(path.join(os.tmpdir(), "civitas-live-cache-"));
    ...
    previousCacheTraceEnv = {
      enabled: process.env.CIVITAS_CACHE_TRACE,
      file: process.env.CIVITAS_CACHE_TRACE_FILE,
      messages: process.env.CIVITAS_CACHE_TRACE_MESSAGES,
      prompt: process.env.CIVITAS_CACHE_TRACE_PROMPT,
      system: process.env.CIVITAS_CACHE_TRACE_SYSTEM,
    };
    process.env.CIVITAS_CACHE_TRACE = "1";
    process.env.CIVITAS_CACHE_TRACE_FILE = liveCacheTraceFile;
    process.env.CIVITAS_CACHE_TRACE_MESSAGES = "0";
    process.env.CIVITAS_CACHE_TRACE_PROMPT = "0";
    process.env.CIVITAS_CACHE_TRACE_SYSTEM = "0";
  }, 120_000);
  ...
  afterAll(async () => {
    if (previousCacheTraceEnv) {
      const restore = (
        key:
          | "CIVITAS_CACHE_TRACE"
          | "CIVITAS_CACHE_TRACE_FILE"
          | "CIVITAS_CACHE_TRACE_MESSAGES"
          | "CIVITAS_CACHE_TRACE_PROMPT"
          | "CIVITAS_CACHE_TRACE_SYSTEM",
      ...
      restore("CIVITAS_CACHE_TRACE", previousCacheTraceEnv.enabled);
      restore("CIVITAS_CACHE_TRACE_FILE", previousCacheTraceEnv.file);
      restore("CIVITAS_CACHE_TRACE_MESSAGES", previousCacheTraceEnv.messages);
      restore("CIVITAS_CACHE_TRACE_PROMPT", previousCacheTraceEnv.prompt);
      restore("CIVITAS_CACHE_TRACE_SYSTEM", previousCacheTraceEnv.system);
    }
  ...
  describe("openai", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "CIVITAS_LIVE_OPENAI_CACHE_MODEL",
  ...
  describe("anthropic", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "CIVITAS_LIVE_ANTHROPIC_CACHE_MODEL",
