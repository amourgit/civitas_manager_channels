...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "civitas-openai-responses-transport",
  "openai-codex-responses": "civitas-openai-responses-transport",
  "openai-completions": "civitas-openai-completions-transport",
  "azure-openai-responses": "civitas-azure-openai-responses-transport",
  "anthropic-messages": "civitas-anthropic-messages-transport",
  "google-generative-ai": "civitas-google-generative-ai-transport",
};
