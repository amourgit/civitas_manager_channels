...
function resolveWatchPaths(workspaceDir: string, config?: CIVITASConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CIVITASConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CIVITASConfig }) {
