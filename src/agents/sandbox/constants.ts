...
export const DEFAULT_SANDBOX_IMAGE = "civitas-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "civitas-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "civitas-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "civitas-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "civitas-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "civitas-sandbox-browser";
