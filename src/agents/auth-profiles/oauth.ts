...
import { loadConfig, type CIVITASConfig } from "../../config/config.js";
...
type SecretDefaults = NonNullable<CIVITASConfig["secrets"]>["defaults"];
...
async function resolveProfileSecretString(params: {
  ...
  configForRefResolution: CIVITASConfig;
