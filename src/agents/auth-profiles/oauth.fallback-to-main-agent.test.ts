...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveCIVITASAgentDir() returns mainAgentDir
    process.env.CIVITAS_STATE_DIR = tmpDir;
    process.env.CIVITAS_AGENT_DIR = mainAgentDir;
