...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.civitas/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "civitas doctor" and "civitas approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
