  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/civitas/civitas/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("civitas:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/civitas/civitas/issues/8643
      try {
        try {
