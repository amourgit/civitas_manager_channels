...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "civitas.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "civitas.sessions_yield";
const SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS = process.env.CIVITAS_TEST_FAST === "1" ? 250 : 2_000;
