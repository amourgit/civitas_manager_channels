      ...
      switch (params.provider) {
        case "ollama":
          return (
            ...
            'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "civitas configure". ' +
            "See: https://docs.civitas.ai/providers/ollama"
          );
        case "vllm":
          return (
            "vLLM requires authentication to be registered as a provider. " +
            'Set VLLM_API_KEY (any value works) or run "civitas configure". ' +
            "See: https://docs.civitas.ai/providers/vllm"
          );
        default:
          return undefined;
      }
