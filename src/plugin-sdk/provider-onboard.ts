...
export type { CIVITASConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: CIVITASConfig, ...args: TArgs) => CIVITASConfig;
  applyConfig: (cfg: CIVITASConfig, ...args: TArgs) => CIVITASConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: CIVITASConfig, preset: TParams) => CIVITASConfig;
  primaryModelRef: string;
