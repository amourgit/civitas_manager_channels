...
import type { CIVITASPluginApi } from "../plugins/types.js";
...
export type { CIVITASPluginToolContext, CIVITASPluginToolFactory } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: CIVITASPluginApi) => void;
  registerFull?: (api: CIVITASPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: CIVITASConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
