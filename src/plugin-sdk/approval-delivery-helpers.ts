...
import type { CIVITASConfig } from "./config-runtime.js";
...
type ApproverRestrictedNativeApprovalParams = {
  ...
  isNativeDeliveryEnabled: (params: { cfg: CIVITASConfig; accountId?: string | null }) => boolean;
...
function buildApproverRestrictedNativeApprovalCapability(
  ...
  return createChannelApprovalCapability({
    ...
    approvals: {
      delivery: {
        hasConfiguredDmRoute: ({ cfg }: { cfg: CIVITASConfig }) =>
