...
const shouldWarnCompatImport =
  ...
  process.env.CIVITAS_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "civitas/plugin-sdk/compat is deprecated for new plugins. Migrate to focused civitas/plugin-sdk/<subpath> imports. See https://docs.civitas.ai/plugins/sdk-migration",
    {
      code: "CIVITAS_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.civitas.ai/plugins/sdk-migration",
    },
  );
}
