    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["civitas directory self --channel slack", "Show the connected account identity."],
          [
            'civitas directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["civitas directory groups list --channel discord", "List available groups/channels."],
          [
            "civitas directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.civitas.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
