...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: CIVITASConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: CIVITASConfig, mode: ChannelAuthMode): string {
