      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["civitas gateway run", "Run the gateway in the foreground."],
            ["civitas gateway status", "Show service status and probe reachability."],
            ["civitas gateway discover", "Find local and wide-area gateway beacons."],
            ["civitas gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.civitas.ai/cli/gateway")}\n`,
      ),
  );
