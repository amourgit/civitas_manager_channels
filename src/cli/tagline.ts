const DEFAULT_TAGLINE = "All your chats, one CIVITAS.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little CIVITAS Channel-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew CIVITAS Channels—type something and let the bot pinch the busywork.",
  ...
  "Automation with CIVITAS Channels: minimal fuss, maximal pinch.",
  ...
  "Channels out, commit in—let's ship something mildly responsible.",
  ...
  "You had me at 'civitas gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.CIVITAS_TAGLINE_INDEX;
