    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["civitas channels list", "List configured channels and auth profiles."],
          ["civitas channels status --probe", "Run channel status checks and probes."],
          [
            "civitas channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["civitas channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.civitas.ai/cli/channels",
        )}\n`,
    );
