...
let originalCIVITASTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalCIVITASTestConsole = process.env.CIVITAS_TEST_CONSOLE;
  process.env.CIVITAS_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalCIVITASTestConsole === undefined) {
    delete process.env.CIVITAS_TEST_CONSOLE;
  } else {
    process.env.CIVITAS_TEST_CONSOLE = originalCIVITASTestConsole;
  }
