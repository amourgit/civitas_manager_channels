...
function resolveDefaultAccountId(cfg: CIVITASConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CIVITASConfig): boolean {
...
export function summarizeBindings(cfg: CIVITASConfig, bindings: AgentBinding[]): string[] {
