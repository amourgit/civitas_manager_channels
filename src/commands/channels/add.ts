...
import { replaceConfigFile, type CIVITASConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: CIVITASConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as CIVITASConfig;
  ...
  // May trigger loadCIVITASPlugins on cache miss (disk scan + jiti import)
