...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set CIVITAS_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `civitas dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control CIVITAS.");
  } else if (hint) {
    runtime.log(hint);
  }
}
