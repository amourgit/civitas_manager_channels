...
export function scanLegacyToolsBySenderKeys(cfg: CIVITASConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: CIVITASConfig): {
