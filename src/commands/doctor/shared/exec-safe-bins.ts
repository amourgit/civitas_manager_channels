...
function collectExecSafeBinScopes(cfg: CIVITASConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: CIVITASConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: CIVITASConfig): {
