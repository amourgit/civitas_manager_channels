...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.civitas.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("civitas hooks list")}`,
      `  ${formatCliCommand("civitas hooks enable <name>")}`,
      `  ${formatCliCommand("civitas hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
