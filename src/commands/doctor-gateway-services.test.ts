...
describe("maybeRepairGatewayServiceConfig", () => {
  ...
  it("does not flag entrypoint mismatch when symlink and realpath match", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/civitas/dist/index.js",
      installEntrypoint:
        "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/civitas@2026.3.12/node_modules/civitas/dist/index.js",
      realpath: async (value: string) => {
        if (value.includes("/global/5/node_modules/civitas/")) {
          return value.replace(
            "/global/5/node_modules/civitas/",
            "/global/5/node_modules/.pnpm/civitas@2026.3.12/node_modules/civitas/",
          );
        }
        return value;
      },
  ...
  it("does not flag entrypoint mismatch when realpath fails but normalized absolute paths match", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/opt/civitas/../civitas/dist/index.js",
      installEntrypoint: "/opt/civitas/dist/index.js",
  ...
  it("still flags entrypoint mismatch when canonicalized paths differ", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint:
        "/Users/test/.nvm/versions/node/v22.0.0/lib/node_modules/civitas/dist/index.js",
      installEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/civitas/dist/index.js",
    });
  ...
  it("repairs entrypoint mismatch in non-interactive fix mode", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/npm/node_modules/civitas/dist/entry.js",
      installEntrypoint: "/Users/test/Library/npm/node_modules/civitas/dist/index.js",
