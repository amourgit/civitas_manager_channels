...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("civitas tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("civitas tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: CIVITASConfig) {
