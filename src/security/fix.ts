...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CIVITASConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CIVITASConfig; env: NodeJS.ProcessEnv }): {
  cfg: CIVITASConfig;
  changes: string[];
} {
