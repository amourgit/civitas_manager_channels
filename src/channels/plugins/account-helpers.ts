...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: CIVITASConfig): string | undefined {
  ...
  function listAccountIds(cfg: CIVITASConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: CIVITASConfig): string {
