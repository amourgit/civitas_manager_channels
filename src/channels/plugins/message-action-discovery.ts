...
export function listChannelMessageActions(cfg: CIVITASConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: CIVITASConfig): ChannelMessageCapability[] {
