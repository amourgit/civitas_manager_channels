...
describe("channel action capability matrix", () => {
  ...
  function getCapabilities(plugin: Pick<ChannelPlugin, "actions">, cfg: CIVITASConfig) {
  ...
  it("forwards Telegram action capabilities through the channel wrapper", () => {
    ...
    const result = getCapabilities(telegramPlugin, {} as CIVITASConfig);
    ...
    const discordResult = getCapabilities(discordPlugin, {} as CIVITASConfig);
