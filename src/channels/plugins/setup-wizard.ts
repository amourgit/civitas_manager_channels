...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: CIVITASConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: CIVITASConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: CIVITASConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: CIVITASConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: CIVITASConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: CIVITASConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: CIVITASConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: CIVITASConfig;
    accountId: string;
