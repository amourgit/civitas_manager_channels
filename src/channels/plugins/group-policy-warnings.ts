...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: CIVITASConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: CIVITASConfig }>(
  collector: WarningCollector<{ cfg: CIVITASConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: CIVITASConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: CIVITASConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: CIVITASConfig },
>(
  projectCfg: (cfg: CIVITASConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: CIVITASConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: CIVITASConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: CIVITASConfig },
>(params: {
  providerConfigPresent: (cfg: CIVITASConfig) => boolean;
